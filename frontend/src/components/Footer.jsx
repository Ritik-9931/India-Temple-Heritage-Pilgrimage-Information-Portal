      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-400 leading-8">
            ...
            pilgrimage circuits, ancient
            architecture, spiritual heritage,
            and divine cultural traditions.
          </p>
          ...
          <div className="flex gap-4 mt-8">
            {/* <a
              href="#"
              className="bg-white/10 hover:bg-orange-500 transition p-3 rounded-full"
            >
              <Facebook size={20} />
            </a>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-center">
            © 2026 India Temple Heritage &
            Pilgrimage. All Rights Reserved.
          </p>
